...
local base06 = "#ffffff"
local base09 = "#78a9ff"
local oxocarbon = (((vim.o.background == "dark") and {base00 = base00, base01 = blend_hex(base00, base06, 0.085), base02 = blend_hex(base00, base06, 0.18), base03 = blend_hex(base00, base06, 0.32), base04 = blend_hex(base00, base06, 0.8), base05 = blend_hex(base00, base06, 0.95), base06 = base06, base07 = "#4db9a7", base08 = "#83f6d6", base09 = base09, base10 = "#f9608f", base11 = "#7bc6d3", base12 = "#f6c177", base13 = "#6cd0a2", base14 = "#c4a7e7", base15 = "#79d6e6", blend = "#0f0f0f", none = "NONE"}) or {base00 = base06, base01 = blend_hex(base00, base06, 0.95), base02 = blend_hex(base00, base06, 0.82), base03 = base00, base04 = "#37474F", base05 = "#90A4AE", base06 = "#525252", base07 = "#08bdba", base08 = "#ff7eb6", base09 = "#ee5396", base10 = "#FF6F00", base11 = "#0f62fe", base12 = "#673AB7", base13 = "#42be65", base14 = "#be95ff", base15 = "#FFAB91", blend = "#FAFAFA", none = "NONE"})
...
vim.api.nvim_set_hl(0, "Search", {fg = oxocarbon.base00, bg = blend_hex(oxocarbon.base00, oxocarbon.base10, 0.3)})
vim.api.nvim_set_hl(0, "IncSearch", {fg = oxocarbon.base00, bg = blend_hex(oxocarbon.base00, oxocarbon.base11, 0.3)})
...
vim.api.nvim_set_hl(0, "Character", {fg = oxocarbon.base07, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@string.regex", {fg = oxocarbon.base12, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@field", {fg = oxocarbon.base13, bg = oxocarbon.none})
